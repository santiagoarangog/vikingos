...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Around | Sign In - Illustration</title>
    <!-- SEO Meta Tags-->
    ...
    <!-- Page loading styles-->
    <script type="text/javascript" src="https://gc.kis.v2.scr.kaspersky-labs.com/FD126C42-EBFA-4E12-B309-BB3FDD723AC1/main.js?attr=Kt-5O7s-DlfJN3FXaqm-MKDf08CGEZuy-F6GhvY_sxfUA-VCXA9I4-ftnxvnmpH7JZG_wpc_QdJAzH3Va3PuG_KnvtawxWNKOFw5vSKSQKg" charset="UTF-8"></script><style>
      .page-loading {
        position: fixed;
        top: 0;
        right: 0;
